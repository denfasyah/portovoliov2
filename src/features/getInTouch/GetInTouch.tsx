...
const SOCIAL_LINKS = [
  {
    name: "GitHub",
    url: "https://github.com/denfasyah",
    icon: (
    ...
    <section id="contact" className="bg-black min-h-screen px-6 py-28 md:px-20 text-white flex flex-col items-center justify-center overflow-hidden">
      <div className="max-w-5xl w-full">
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row md:items-end justify-between mb-20 border-b border-white/10 pb-8 gap-6"
        >
        ...
        <div className="grid md:grid-cols-[1fr_1.5fr] gap-16 items-start">
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div>
                <div className="text-[0.65rem] font-bold uppercase tracking-[0.2em] text-white/30 mb-4">Connect</div>
                <div className="flex gap-4">
                  {SOCIAL_LINKS.map((social) => (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="w-12 h-12 border border-white/20 flex items-center justify-center rounded-sm text-white/50 hover:text-white hover:border-white/50 hover:bg-white/5 transition-colors"
                      title={social.name}
                    >
                      {social.icon}
                    </motion.a>
          ...
          <motion.form
            ...
            className="space-y-6 bg-white/[0.02] border border-white/10 p-8 rounded-sm"
          >
